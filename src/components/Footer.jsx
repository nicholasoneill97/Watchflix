  ...
  return (
    ...
    <div class="max-w-2xl mx-auto text-white py-10">
        ...
        <h1 className='text-cyan-600 text-4xl font-bold cursor-pointer origin-left  duration-300 scale-y-10 slidefromleft'>WATCHFLIX</h1>
            ...
            <p>Endless Movies and Shows</p>
            <div class="flex justify-center my-10">
                <div class="flex items-center border bg-black w-auto rounded-lg px-4 py-2 w-52 mx-2">
        ...
        <div class="mt-28 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
            <p class="order-2 md:order-1 mt-8 md:mt-0">  Coded by Nicholas O'Neill </p>
            <div class="order-1 md:order-2">
                
              <Link to="/login"><span class="px-2 ">Sign In</span></Link>
              <Link to="/signup"><span class="px-2 border-l">Sign Up</span></Link>
            </div>
        </div>
    </div>
</div>
